			...
			<div class="onerow">
		  	...
		  	<div id="tabs-2">
				...
				<div class="onerow">
					...
					<div class="col4 last">
						<input id="chiefdom" name="person.attribute.${personAttributeChiefdom.id}" class="form-textbox"/>
					</div>
				</div>
				...
				<div class="onerow">
					<div class="col4">
						<select id="districts" name="patient.address.district" onChange="PAGE.changeDistrict();" class="form-combo"></select>				
					</div>
					<div class="col4">
						<select id="upazilas" name="patient.address.upazila" onChange="PAGE.changeUpazila();"class="form-combo"></select>
					</div>
					<div class="col4 last">
		  	...
		  	<div id="tabs-3">
				...
				<div class="onerow">
					<div class="col4">
						<span id="payingCategoryField"><select id="payingCategory" name="person.attribute.44" onchange="payingCategorySelection();" class = "form-combo"></select></span>
					
					</div>
					<div class="col4">
						<span id="nonPayingCategoryField"><select id="nonPayingCategory" name="person.attribute.45" onchange="nonPayingCategorySelection();" class = "form-combo">	</select></span>
					</div>
					<div class="col4 last">
						<span id="specialSchemeCategoryField"><select id="specialScheme" name="person.attribute.46" onchange="specialSchemeSelection();" style='width: 152px;' class = "form-combo">	</select></span>
					</div>
				</div>
				...
				<div class="onerow">
					...
					<div class="col4">
						<select id="relationshipType" name="person.attribute.15" style='width: 152px;' class = "form-combo">
